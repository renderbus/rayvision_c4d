...
import os,sys
import platform
# from analysec4d import *


class GetInstallPath(object):
    """ C4d loader class """
    ...
    def GetTempFolder(self, instalDir):
        ...
        crc = GetInstallPath.CRC(parentDirLower)
    ...
    def install_path(self, winInstallationPath):
        # Path must be in unicode, it can be retrieved from c4d with c4d.storage.GeGetStartupPath()
        pref_path = self.GetTempFolder(winInstallationPath)
        return pref_path
